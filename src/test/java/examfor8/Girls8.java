...
public class Girls8 extends BaseTest {
    GFG gf = new GFG();
    public String text;
    ...
    @Test(priority = 1 , dataProvider="testData8Girls",dataProviderClass= testDataFor8Girls.class)
    public void girls8(String rollno , String name, String fname) throws InterruptedException {
        driver.manage().timeouts().implicitlyWait(900, TimeUnit.SECONDS);
