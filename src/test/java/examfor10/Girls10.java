...
public class Girls10 extends BaseTest{
    ...
    public void girls10(String rollno , String name, String fname) throws InterruptedException {
        ...
        m.get(1).click();
        Thread.sleep(300);
        WebElement button = driver.findElement(By.xpath("//span[text()='10']"));
     ...
     /*   Integer x = Integer.valueOf(rollno);
        ...
        // Multiple Answer
        List<WebElement> seventhopt = driver.findElements(By.xpath("//span[text()='"+seventh+"']"));
        seventhopt.get(0).click();  //8
        //8
